...
\begin{table}[!htbp]
\caption{Ablation on retain ratio, with training cost. Time/Step and Total (6-Step) are measured wall-clock figures.}
\centering
\begin{tabular}{lcccccc}
\toprule
Retain Ratio & Time/Step (min) & Total, 6-Step (min) & $Acc_f$ & $Acc_r$ & $Acc_n$ \\
\midrule
1.0 & 22.3 & 133.8 & 0.40 & 68.00 & 81.74 \\
0.5 & 17.1 & 102.6 & 0.00 & 70.00 & 71.05 \\
0.3 & 14.3 & 85.8 & 0.00 & 66.00 & 79.11 \\
\rowcolor{orange!20}
0.1 & 11.7 & 70.2 & 0.00 & 65.00 & 79.96 \\
\bottomrule
\end{tabular}
...
\subsubsection{Unlearning Evidence Under Attack}
\label{7.7}

\begin{table}[!htbp]
\centering
\footnotesize
\caption{Unlearning evidence under attack: nine tests spanning forgetting, information recoverability, privacy attacks, and Oracle consistency, on the Task-6 CIFAR-100 checkpoint over all 60 classes forgotten during Tasks 1--6. N/A = not applicable.}
