...
\begin{align}
    ...
    f_{\mathcal{M}^{(t)}} &: \mathcal{X}_{D_{\text{new}}^{(t)}} \rightarrow \mathcal{Y}_{D_{\text{new}}^{(t)}} \label{Eq:3c}
\end{align}
\end{subequations}
...
\begin{enumerate}
    ...
    \item All adapter matrices and forgotten-class classifier-head nodes permanently deleted post-merge.
\end{enumerate}
