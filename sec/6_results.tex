...
% !!! PLACEHOLDER NUMBERS continued (Tasks 7-12) -- see note above.
\begin{table}[!htbp]
\centering
\renewcommand{\arraystretch}{1.30}
\caption{\textcolor{red}{Performance comparison, Tasks 7--12, continual learning-unlearning on Face Recognition on VGGFace2 (200 identities), continued from Table~\ref{tab:face_recognition}. BID-LoRA results are mean$_{\pm\text{std}}$ over 3 seeds. Values shown are placeholder/dummy, pending real experiments.}}
\label{tab:face_recognition2}
\begin{adjustbox}{max width=\textwidth}
\setlength{\tabcolsep}{3pt}
\begin{tabular}{l|c|cccc|cccc}
\toprule
